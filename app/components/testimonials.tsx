      ...
      <div className="mx-auto -mt-[120px]">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-start w-full">
            ...
            <p className="text-[28px] sm:text-[40px] lg:text-[48px] xl:text-[60px] text-myWhite font-bold mt-4 leading-tight">
          ...
          <div className="flex items-center justify-center mx-auto mt-16 px-4">
            <div className="relative group flex flex-col items-center justify-center">
              ...
              {/* White Box with Text */}
              <div className="relative w-full max-w-[868px] h-auto bg-myWhite flex flex-col items-center justify-center p-8 -z-10 -mt-10 md:w-[90%]">
  {/* Quote Icon */}
  <Image
    alt="Quote Icon"
