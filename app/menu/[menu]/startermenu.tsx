...
const StarterMenu = () => {
  const menuItems = [
    {
      subHeading: "Alder Grilled Chinook Salmon",
      detail: "Toasted French bread topped with romano, cheddar",
      cal: "560 CAL",
      price: "32$",
    },
    {
      subHeading: "Berries and creme tart",
      detail: "Gorgonzola, ricotta, mozzarella, taleggio",
      cal: "700 CAL",
      price: "43$",
    },
    {
      subHeading: "Tormentoso Bush Pizza Pintoage",
  ...
  return (
    <div className="w-full bg-myWhite">
      {/* Menu Section */}
      <div className="mx-auto w-full max-w-[1560px] px-8 mt-20">
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          {/* Static Image */}
          <div className="lg:w-1/2">
            <Image
              src="/assets/menu/startermenu.png"
              alt="Starter Menu"
              width={488}
              height={626}
          ...
          <div className="lg:w-1/2 flex flex-col justify-start">
            ...
            <h1 className="text-[40px] text-black1 font-bold">Starter Menu</h1>
          </div>
